...
\keywords{Manchester Decoding, Sniffer und Datalogger, Multifunction Vehicle Bus, MVB}
...
\studyprogram{Systemtechnik} 
                                        % Study program                       \studyprog
\studyprogramlink{https://www.zhaw.ch/de/engineering/studium/bachelorstudium/systemtechnik/}
                                        % Link to study program               \studyproglink

\supervisorA{Patrick Rennahard}       % Name of supervisor 1,               \supnameA
...
\department{Shool of Engineering} 
                                        % Department,                         \deptname
